...
import WorldEventsCarousel from '@/components/landing/WorldEventsCarousel';
  ...
  return (
    ...
    >
      <div className="bg-[#1B1913] border border-cursor-border rounded-lg p-6">
        ...
        <p className="text-cursor-text-muted text-sm md:text-base mb-6">
          {t('worldEvents.description')}
        </p>
        <WorldEventsCarousel />
      </div>
    </motion.section>
