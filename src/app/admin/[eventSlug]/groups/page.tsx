  ...
  return (
    <div className="min-h-screen bg-black-gradient text-white flex flex-col relative overflow-hidden">
      ...
      <footer className="py-12 px-6 border-t border-white/[0.03] flex justify-between items-center z-10">
        ...
        <div className="flex items-center gap-6">
          <p className="text-[10px] uppercase tracking-[0.3em] text-gray-800 font-medium">Intelligence Unit</p>
          <span className="text-[10px] font-medium text-white/40 px-5 py-2 bg-white/[0.02] rounded-full border border-white/[0.05]">Neural Protocol</span>
        </div>
      </footer>
    </div>
  );
